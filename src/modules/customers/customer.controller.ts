...
export const toggleCustomer = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const resetCustomerPin = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const exitCustomer = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const getCustomerByUserId = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const setPauseWindow = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const getPauseHistory = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const cancelPause = async (req: Request, res: Response, next: NextFunction) => {
  try {
